        ...
        <section className="relative h-[65vh] min-h-[520px] flex items-end overflow-hidden">
          ...
          <div className="relative z-10 w-full pb-14 px-4">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-[#c9a84c] text-xs uppercase tracking-[0.3em] mb-2">Sacred Journeys</p>
        ...
        <section className="py-24 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-14">
              <p className="text-[#c9a84c] text-xs uppercase tracking-widest mb-3">Where We Go</p>
                ...
                {packages.map(pkg => (
                  <div key={pkg.id} className="glass rounded-2xl p-7 flex flex-col hover:border-[#c9a84c]/20 transition-all hover:-translate-y-1">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/[0.06]">
                      <div>
                        <p className="text-[#c9a84c] font-black text-2xl">₹{pkg.price.toLocaleString()}</p>
