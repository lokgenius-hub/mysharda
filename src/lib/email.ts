      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f0f23; color: #fff; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 24px;">
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 8px 0; color: #c9a84c; width: 120px; vertical-align: top;">Name</td>
              <td style="padding: 8px 0; color: #fff;">${enquiry.name}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #c9a84c; vertical-align: top;">Phone</td>
              <td style="padding: 8px 0; color: #fff;">
                <a href="tel:+91${enquiry.phone}" style="color: #c9a84c; text-decoration: none;">+91 ${enquiry.phone}</a>
              </td>
            </tr>
            ${enquiry.email ? `<tr><td style="padding: 8px 0; color: #c9a84c; vertical-align: top;">Email</td><td style="padding: 8px 0; color: #fff;">${enquiry.email}</td></tr>` : ''}
            <tr>
              <td style="padding: 8px 0; color: #c9a84c; vertical-align: top;">Type</td>
              <td style="padding: 8px 0; color: #fff; text-transform: capitalize;">${enquiry.enquiry_type}</td>
            </tr>
            ${enquiry.preferred_date ? `<tr><td style="padding: 8px 0; color: #c9a84c; vertical-align: top;">Date</td><td style="padding: 8px 0; color: #fff;">${enquiry.preferred_date}</td></tr>` : ''}
            ${enquiry.guests ? `<tr><td style="padding: 8px 0; color: #c9a84c; vertical-align: top;">Guests</td><td style="padding: 8px 0; color: #fff;">${enquiry.guests}</td></tr>` : ''}
            ${enquiry.message ? `<tr><td style="padding: 8px 0; color: #c9a84c; vertical-align: top;">Message</td><td style="padding: 8px 0; color: #fff;">${enquiry.message}</td></tr>` : ''}
          </table>
          <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.1);">
            <a href="https://wa.me/91${enquiry.phone}?text=Hi%20${encodeURIComponent(enquiry.name)}%2C%20thank%20you%20for%20contacting%20Sharda%20Palace!" 
            ...
            <a href="tel:+91${enquiry.phone}" 
               style="display: inline-block; padding: 10px 20px; background: #c9a84c; color: #0f0f23; text-decoration: none; border-radius: 8px; font-weight: bold;">
              📞 Call
            </a>
          </div>
        </div>
        <div style="padding: 12px 24px; background: rgba(255,255,255,0.03); color: rgba(255,255,255,0.3); text-align: center; font-size: 12px;">
          Sharda Palace Admin Notification
        </div>
      </div>
    `
